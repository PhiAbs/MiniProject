...
baseline_thresh = 0.001; % 0.001: good. larger number means less features (but better triangulation)
...
nonmax_suppression_radius = 20; % 15: good. larger number means less features
harris_rejection_radius = 20; % 15: good TODO: make it same as nonmax suppression radius? 10: good for kitti
p3p_pixel_thresh = 1;  % 1: good. 5: not so good. larger number means more features, but worse quality
p3p_num_iter = 10000;
reprojection_thresh_p3p = 4;  % 3: good
BA_iter = 2;
num_BA_frames = 20;  % 20: good
max_iter_BA = 100;
num_fixed_frames_BA = 1;  % 1: good
absoluteTolerance_BA = 0.001;
reprojection_thresh = 4;  
plot_stuff = false;
...
% p3p_pixel_thresh = 1;  % 1: good. 5: not so good. larger number means more features, but worse quality
% p3p_num_iter = 10000;
% reprojection_thresh_p3p = 2;  % 3: good
% BA_iter = 2;
% num_BA_frames = 20;  % 20: good
% max_iter_BA = 100;
% num_fixed_frames_BA = 1;  % 1: good
